...
const hiFlat = {
  ...
  "homeSections.farmingPromo.title": "दीर्घकालिक मूल्य के लिए उच्च संभावित कृषि अवसर",
  "homeSections.farmingPromo.description":
    "मिट्टी प्रोफ़ाइल, सिंचाई उपलब्धता और जिला-स्तरीय विकास मांग से जुड़े व्यावहारिक डेटा के साथ सत्यापित कृषि भूमि लिस्टिंग खोजें।",
  "homeSections.farmingPromo.badges.verifiedDocs": "सत्यापित दस्तावेज़",
  "homeSections.farmingPromo.badges.farmingFilters": "कृषि-विशिष्ट फ़िल्टर",
  "homeSections.farmingPromo.badges.advisorSupport": "सलाहकार सहायता",
  "homeSections.farmingPromo.ctaExplore": "कृषि भूमि देखें",
  "homeSections.farmingPromo.ctaPostLand": "अपनी जमीन पोस्ट करें",
  "homeSections.farmingPromo.imageAlt": "कृषि भूमि का हवाई दृश्य",
  "homeSections.featuredFarms.eyebrow": "फीचर्ड",
  "homeSections.featuredFarms.title": "भूमिवाला आश्वस्त — अत्यधिक अनुशंसित फीचर्ड प्रॉपर्टी",
  "homeSections.featuredFarms.description": "यहाँ केवल सक्रिय फीचर्ड प्रॉपर्टी दिखाई जाती हैं।",
  "homeSections.districtExplorer.eyebrow": "स्थान एक्सप्लोरर",
  "homeSections.districtExplorer.title": "शीर्ष कृषि भूमि खोजें",
  "homeSections.districtExplorer.description": "अवसर खोजें और उपलब्ध इन्वेंटरी में तुरंत जाएँ।",
  "homeSections.districtExplorer.listingsCount": "{{count}}+ कृषि भूमि",
  "homeSections.districtExplorer.viewListings": "लिस्टिंग देखें",
  "homeSections.districtExplorer.ariaExploreDistrict": "{{district}} में कृषि भूमि लिस्टिंग देखें",
  "homeSections.districtExplorer.imageAlt": "{{district}} में कृषि भूमि",
  "homeSections.benefits.eyebrow": "हमें क्यों चुनें",
  "homeSections.benefits.title": "आधुनिक कृषि भूमि लेनदेन के लिए बनाया गया",
  "homeSections.benefits.description":
    "खोज, जाँच और समापन में घर्षण कम करने के लिए डिज़ाइन किया गया केंद्रित अनुभव।",
  "homeSections.footerCta.title": "अपना अगला कृषि भूमि निवेश खोजने के लिए तैयार हैं?",
  "homeSections.footerCta.description":
    "सत्यापित लिस्टिंग देखें, कृषि-विशिष्ट मेट्रिक्स की तुलना करें, और आत्मविश्वास से समापन के लिए भूमि मालिकों और सलाहकारों से सीधे जुड़ें।",
  "homeSections.footerCta.ctaExplore": "खोज शुरू करें",
  "homeSections.footerCta.ctaPostFree": "मुफ़्त में जमीन पोस्ट करें",
