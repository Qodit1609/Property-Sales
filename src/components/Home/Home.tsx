...
const Home: React.FC = () => {
  ...
  const selectClass =
    "w-full px-4 py-3 rounded-lg bg-[var(--white)] text-[var(--b1)] border border-[var(--b2)] focus:outline-none focus:border-[var(--b1-mid)] focus:ring-2 focus:ring-[var(--b2)]";
  ...
  return (
    <section className="relative min-h-[120vh] pt-[80px] pb-[220px]">
      ...
      <div className="absolute left-1/2 bottom-[-45px] z-20 w-full -translate-x-1/2 px-4">
        <div className="w-[94%] max-w-[1200px] mx-auto bg-[var(--b2-soft)] rounded-2xl shadow-2xl px-4 sm:px-6 py-5">
          <form className="grid grid-cols-1 sm:grid-cols-2 md:flex gap-3 items-stretch">
            <select className={`${selectClass} md:w-[180px]`}>
              <option className="bg-[var(--white)] text-[var(--b1)]">
                Location
              </option>
              <option className="bg-[var(--white)] text-[var(--b1)]">
                Indore
            ...
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg bg-[var(--white)] text-[var(--b1)] border border-[var(--b2)] focus:outline-none focus:border-[var(--b1-mid)] focus:ring-2 focus:ring-[var(--b2)]"
            />

            <button
              type="submit"
              className="w-full md:w-auto px-6 py-3 rounded-lg bg-[var(--b1-mid)] hover:bg-[var(--b1)] transition text-fg font-semibold flex items-center justify-center gap-2"
            >
              <svg
