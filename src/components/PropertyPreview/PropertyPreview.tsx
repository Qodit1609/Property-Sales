      ...
      <div className="w-full max-w-[1280px] px-4 sm:px-6 lg:px-10 mx-auto">
        ...
        <div className="mt-3 bg-gradient-to-r from-[#347928] via-[#3f8f31] to-[#C0EBA6] text-white rounded-xl py-4">
          <div className="px-4 sm:px-5 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-3">
            ...
            <div className="bg-[#FFFBE6] text-gray-900 rounded-xl p-4 h-fit">
              <h3 className="text-xs font-semibold mb-2 text-[#347928]">
                Contact an agent
              </h3>
              ...
              <button className="mt-3 w-full px-4 py-2 rounded-full bg-[#347928] text-white text-xs font-semibold hover:bg-[#2d6522] transition">
                Request details
              </button>
            </div>
          </div>
