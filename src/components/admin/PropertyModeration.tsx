...
const PropertyModeration: React.FC<PropertyModerationProps> = ({
  ...
  const actionBtnBase =
    "inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-[11px] font-medium disabled:opacity-60";
                ...
                <td className="px-4 py-3 align-top text-right">
                  <div className="flex flex-wrap justify-end gap-1.5">
                    <button
                      ...
                      className={`${actionBtnBase} border border-emerald-500/40 bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20`}
                    >
                    ...
                    <button
                      ...
                      className={`${actionBtnBase} border border-amber-500/40 bg-amber-500/10 text-amber-600 hover:bg-amber-500/20`}
                    >
                    ...
                    <button
                      ...
                      className={`${actionBtnBase} border border-rose-500/40 bg-rose-500/10 text-rose-600 hover:bg-rose-500/20`}
                    >
