...
const SellerTestimonialPage: React.FC = () => {
  ...
  const handleSubmit = async (payload: CreateTestimonialRequest) => {
    ...
    try {
      ...
      pushToast({
        ...
        detail:
          error instanceof Error ? error.message : t("buyerPanel.testimonial.toast.failedDetail"),
      });
    } finally {
      setSubmitting(false);
    }
...
export default SellerTestimonialPage;
